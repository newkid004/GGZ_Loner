...
namespace Habrador_Computational_Geometry
{
	...
	public static class _EarClipping
	{
		...
		public static HashSet<Triangle2> Triangulate(List<Vector2> vertices, List<List<Vector2>> allHoleVertices = null, bool optimizeTriangles = true)
		{
			//Validate the data
		...
		private static void OptimizeTriangle(Triangle2 t, HashSet<Triangle2> triangulation)
		{
			...
			Vector2 a = edgeToSwap.p2;
			Vector2 c = edgeToSwap.p1;
			Vector2 b = t.GetVertexWhichIsNotPartOfEdge(edgeToSwap);
			Vector2 d = tOpposite.GetVertexWhichIsNotPartOfEdge(edgeToSwap);
		...
		private static void FindEdgeInTriangulation(Triangle2 tNew, HashSet<Triangle2> triangulation, out bool hasOppositeEdge, out Triangle2 tOpposite, out Edge2 edgeToSwap)
		{
			...
			Vector2 vertexWithBiggestInteriorAngle = tNew.p1;
