...
namespace Habrador_Computational_Geometry
{
	public static class _Delaunay
	{
		...
		public static HalfEdgeData2 FlippingEdges(HashSet<Vector2> points, HalfEdgeData2 triangleData)
		{
		...
		public static HalfEdgeData2 ConstrainedBySloan(HashSet<Vector2> points, List<Vector2> hull, HashSet<List<Vector2>> holes, bool shouldRemoveTriangles, HalfEdgeData2 triangleData)
		{
