...
namespace Habrador_Computational_Geometry
{
	...
	public static class PointTriangulationIntersection
	{
		...
		//Simple but slow
		public static HalfEdgeFace2 BruteForce(Vector2 p, HalfEdgeData2 triangulationData)
		{
			...
			foreach (HalfEdgeFace2 f in triangulationData.faces)
			{
				...
				Vector2 v1 = f.edge.v.position;
				Vector2 v2 = f.edge.nextEdge.v.position;
				Vector2 v3 = f.edge.nextEdge.nextEdge.v.position;
