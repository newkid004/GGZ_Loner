...
namespace Habrador_Computational_Geometry
{
	...
	public class BezierCubic : _Curve
	{
		...
		public static Vector3 GetPosition(Vector3 posA, Vector3 posB, Vector3 handlePosA, Vector3 handlePosB, float t)
		{
			...
			//Vector3 interpolation_1 = BezierLinear(posA, handlePosA, t);
			//Vector3 interpolation_2 = BezierLinear(handlePosA, handlePosB, t);
			//Vector3 interpolation_3 = BezierLinear(handlePosB, posB, t);

			//Vector3 interpolation_1_2 = BezierLinear(interpolation_1, interpolation_2, t);
			//Vector3 interpolation_2_3 = BezierLinear(interpolation_2, interpolation_3, t);


			//Above can be simplified if we are utilizing the quadratic bezier
			//Vector3 interpolation_1_2 = BezierQuadratic.GetPosition(posA, handlePosB, handlePosA, t);
			//Vector3 interpolation_2_3 = BezierQuadratic.GetPosition(handlePosA, posB, handlePosB, t);

			//Vector3 finalInterpolation = BezierLinear.GetPosition(interpolation_1_2, interpolation_2_3, t);
		...
		public static Vector3 GetTangent(Vector3 posA, Vector3 posB, Vector3 handlePosA, Vector3 handlePosB, float t)
		{
			...
			//Vector3 tangent = Vector3.Normalize(interpolation_2_3 - interpolation_1_2);
