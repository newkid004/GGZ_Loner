...
namespace Habrador_Computational_Geometry
{
	...
	public class BezierQuadratic : _Curve
	{
		...
		public static Vector3 GetPosition(Vector3 posA, Vector3 posB, Vector3 handlePos, float t)
		{
			...
			//Vector3 interpolation_posA_handlePos = BezierLinear.GetPosition(posA, handlePos, t);
			//Vector3 interpolation_handlePos_posB = BezierLinear.GetPosition(handlePos, posB, t);

			//Vector3 finalInterpolation = BezierLinear.GetPosition(interpolation_posA_handlePos, interpolation_handlePos_posB, t);
		...
		public static Vector3 GetTangent(Vector3 posA, Vector3 posB, Vector3 handlePos, float t)
		{
			...
			//Vector3 tangent = Vector3.Normalize(interpolation_handlePos_posB - interpolation_posA_handlePos);
