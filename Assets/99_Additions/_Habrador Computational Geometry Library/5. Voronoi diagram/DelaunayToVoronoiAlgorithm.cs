...
namespace Habrador_Computational_Geometry
{
	...
	{
		public static HashSet<VoronoiCell2> GenerateVoronoiDiagram(HashSet<Vector2> sites)
		{
			...
			foreach (HalfEdgeFace2 t in triangles)
			{
				...
				Vector2 v1 = e1.v.position;
				Vector2 v2 = e2.v.position;
				Vector2 v3 = e3.v.position;
				...
				Vector2 voronoiVertex = _Geometry.CalculateCircleCenter(v1, v2, v3);
		...
		private static void TryAddVoronoiEdgeFromTriangleEdge(HalfEdge2 e, Vector2 voronoiVertex, List<VoronoiEdge2> allEdges)
		{
			...
			Vector2 v1 = eNeighbor.v.position;
			Vector2 v2 = eNeighbor.nextEdge.v.position;
			Vector2 v3 = eNeighbor.nextEdge.nextEdge.v.position;

			Vector2 voronoiVertexNeighbor = _Geometry.CalculateCircleCenter(v1, v2, v3);
