...
namespace Habrador_Computational_Geometry
{
	public static class _ConvexHull
	{
		...
		public static List<Vector2> JarvisMarch_2D(HashSet<Vector2> points)
		{
			...
			List<Vector2> pointsOnHull = JarvisMarchAlgorithm2D.GenerateConvexHull(pointsList);
		...
		//Quickhull
		public static List<Vector2> Quickhull_2D(HashSet<Vector2> points, bool includeColinearPoints)
		{
			List<Vector2> pointsList = new List<Vector2>(points);
			...
			//Has to return a list and not hashset because the points have an order coming after each other
			List<Vector2> pointsOnHull = QuickhullAlgorithm2D.GenerateConvexHull(pointsList, includeColinearPoints);
		...
		//
		private static bool CanFormConvexHull_2d(List<Vector2> points)
		{
