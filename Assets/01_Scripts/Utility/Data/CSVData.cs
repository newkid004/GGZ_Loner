...
namespace GGZ
{
	public static class CSVData
	{
		public static class Battle
		{
			...
			{
				public class Define : CSVObjectBase<Define, int>
				{
					public override int GetKey() => ID;
				...
				public class Status : CSVObjectBase<Status, int>
				{
					public override int GetKey() => ID;
			...
			public static class Skill
			{
				...
				public class BulletInfo : CSVObjectBase<BulletInfo, int>
				{
					...
					/* 탄환과 발사한 위치의 간격 ( 캐릭터 크기 기준 )
					 * 0 : 탄환의 반지름만큼 떨어져서 시작
					 * 1 : 탄환의 반지름 + 캐릭터 크기만큼 떨어져서 시작
					 * N : 탄환의 반지름 + 캐릭터 크기 * N 만큼 떨어져서 시작
					 */
			...
			public static class Status
			{
				...
				public class Monster : CSVObjectBase<Monster, int>
				{
					...
					public float ReactIntervalNormal;
					public float ReactIntervalAggressive;
				}
			}
