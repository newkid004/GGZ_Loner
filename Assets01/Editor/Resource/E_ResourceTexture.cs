...
namespace Proto_00_N
{
	public class E_ResourceTexture : AssetPostprocessor
	{
		...
		{
			listHsIgnoreFileName[(int)ETextureType.Stage].Add("Stage_001_Background 1.png");
			listHsIgnoreFileName[(int)ETextureType.Stage].Add("Stage_001_Field 1.png");
			listHsIgnoreFileName[(int)ETextureType.Stage].Add("Stage_001_Front 1.png");
		}
