...
namespace Habrador_Computational_Geometry
{
	...
	public class BezierLinear : _Curve
	{
		...
		public static Vector3 GetPosition(Vector3 a, Vector3 b, float t)
		{
			...
			//Vector3 interpolatedPos = new Vector3(lerpX, lerpY, lerpZ);
		...
		//2d
		public static Vector2 GetPosition(Vector2 a, Vector2 b, float t)
		{
			t = Mathf.Clamp01(t);
			...
			//Vector2 interpolatedPos = new Vector2(lerpX, lerpY);

			//Above is same as
			//(1-t)A + tB = A - At + Bt

			Vector2 interpolatedPos = a - a * t + b * t;
