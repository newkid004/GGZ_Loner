...
namespace Habrador_Computational_Geometry
{
	...
	public class MyMesh
	{
		...
		public MyMesh(Mesh mesh_Unity)
		{
			...
			//Vector3 -> Vector3 
			this.vertices = vertices_Unity.ToList();
			this.normals = normals_Unity.ToList();
		...
		//public void AddNormal(Vector3 normal, int index)
		//{
		...
		public Mesh ConvertToUnityMesh(bool generateNormals, string meshName = null)
		{
			...
			//Vector3 to Vector3
			Vector3[] vertices_Unity = vertices.ToArray();
			...
			{
				//Vector3 to Vector3
				Vector3[] normals_Unity = normals.ToArray();
