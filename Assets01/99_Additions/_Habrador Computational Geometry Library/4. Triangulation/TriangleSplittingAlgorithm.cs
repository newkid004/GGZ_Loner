...
namespace Habrador_Computational_Geometry
{
	...
	{
		public static HashSet<Triangle2> TriangulatePoints(HashSet<Vector2> points, bool addColinearPoints)
		{
			//Step 1. Generate the convex hull
			List<Vector2> pointsOnConvexHull = _ConvexHull.JarvisMarch_2D(points);
			...
			foreach (Vector2 v in pointsOnConvexHull)
			{
				points.Remove(v);
			}
