...
namespace Habrador_Computational_Geometry
{
	...
	public static class _TriangulatePoints
	{
		...
		public static HashSet<Triangle2> TriangleSplitting(HashSet<Vector2> points, bool addColinearPoints)
		{
		...
		public static HashSet<Triangle2> VisibleEdgesTriangulation(HashSet<Vector2> points)
		{
		...
		public static HashSet<Triangle2> PointsOnConvexHull(List<Vector2> pointsOnConvexHull, bool addColinearPoints)
		{
		...
		public static HashSet<Triangle2> PointsOnConvexHull(List<Vector2> pointsOnConvexHull, Vector2 insidePoint)
		{
