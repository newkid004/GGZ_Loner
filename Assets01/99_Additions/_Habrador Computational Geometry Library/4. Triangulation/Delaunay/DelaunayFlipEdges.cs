...
namespace Habrador_Computational_Geometry
{
	...
	{
		public static HalfEdgeData2 GenerateTriangulation(HashSet<Vector2> points, HalfEdgeData2 triangleData)
		{
		...
		private static void FlipEdges(HalfEdgeData2 triangleData)
		{
			...
			while (true)
			{
				...
				foreach (HalfEdge2 thisEdge in edges)
				{
					...
					Vector2 a = thisEdge.v.position;
					Vector2 b = thisEdge.nextEdge.v.position;
					Vector2 c = thisEdge.nextEdge.nextEdge.v.position;
					Vector2 d = thisEdge.oppositeEdge.nextEdge.v.position;
