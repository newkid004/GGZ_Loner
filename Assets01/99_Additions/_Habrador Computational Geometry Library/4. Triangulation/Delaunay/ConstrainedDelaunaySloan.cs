...
namespace Habrador_Computational_Geometry
{
	...
	{
		public static HalfEdgeData2 GenerateTriangulation(HashSet<Vector2> points, List<Vector2> hull, HashSet<List<Vector2>> holes, bool shouldRemoveTriangles, HalfEdgeData2 triangleData)
		{
		...
		private static List<HalfEdge2> RemoveIntersectingEdges(Vector2 v_i, Vector2 v_j, Queue<HalfEdge2> intersectingEdges)
		{
			...
			while (intersectingEdges.Count > 0)
			{
				...
				Vector2 v_3rd = e.nextEdge.v.position;
		...
		public static HashSet<HalfEdgeFace2> FindTrianglesWithinConstraint(HalfEdgeData2 triangleData, List<Vector2> constraints)
		{
		...
		//private static HalfEdgeFace2 FindTriangleWithEdge(Vector2 p1, Vector2 p2, HalfEdgeData2 triangleData)
		//{
		//	HashSet<HalfEdge2> edges = triangleData.edges;
		...
		private static void FindIntersectingEdges_TriangleWalk(HalfEdgeData2 triangleData, Vector2 c_p1, Vector2 c_p2, List<HalfEdge2> intersectingEdges)
		{
		...
		//private static bool IsEdgeAConstraint(Vector2 p1, Vector2 p2, List<Vector2> constraints)
		//{
		//	for (int i = 0; i < constraints.Count; i++)
		//	{
		//		Vector2 c_p1 = constraints[i];
