...
namespace Habrador_Computational_Geometry.Marching_Squares
{
	...
	public class ControlNode : Node
	{
		...
		public ControlNode(Vector2 pos, bool isActive, float squareSize, float value) : base(pos)
		{
			this.isActive = isActive;

			this.above = new Node(base.pos + new Vector2(0f, 1f) * squareSize * 0.5f);

			this.right = new Node(base.pos + new Vector2(1f, 0f) * squareSize * 0.5f);
